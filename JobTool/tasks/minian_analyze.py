...
def schedule_minian_job_for(scheduler, tmpl_loader, collection_id,
                              video_dir, write_video, results_dir):
    job_fname = tmpl_loader.create_job_file('minian-analyze.tmpl',
...
def setup_arguments(parser):
    ...
    parser.add_argument('--out-dset', default='minian-analysis', type=str,
...
def run(scheduler, data_location, options):
    ...
    for edldir in edl_dirs:
        ...
        schedule_minian_job_for(scheduler,
                                tmpl_loader,
                                collection_id,
                                video_dir=dset.path,
